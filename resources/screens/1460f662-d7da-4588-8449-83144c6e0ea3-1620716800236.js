jQuery("#simulation")
  .on("click", ".s-1460f662-d7da-4588-8449-83144c6e0ea3 .click", function(event, data) {
              ...
              "actions": [
                {
                  ...
                  "parameter": {
                    "target": "screens/46884e45-e1b3-4fa8-9f1f-6c58a763e060",
                    "transition": {
                      "type": "slideleft",
                      "duration": 700
                    }
              ...
              "actions": [
                {
                  "action": "jimNavigation",
                  "parameter": {
                    "target": "screens/ebaeafd1-a29a-4b76-8fce-ea3e231b48de",
                    "transition": {
                      "type": "slideleft",
                      "duration": 700
                    }
  ...
  .on("pageload", ".s-1460f662-d7da-4588-8449-83144c6e0ea3 .pageload", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
