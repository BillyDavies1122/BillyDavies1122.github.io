jQuery("#simulation")
  .on("click", ".s-21147a72-76f5-4cc2-925b-8cbdfd94c7be .click", function(event, data) {
  ...
  .on("pageload", ".s-21147a72-76f5-4cc2-925b-8cbdfd94c7be .pageload", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
