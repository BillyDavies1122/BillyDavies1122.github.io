jQuery("#simulation")
  .on("click", ".s-314e8bfc-2d4a-4752-8012-88068a6b86d0 .click", function(event, data) {
  ...
  .on("pageload", ".s-314e8bfc-2d4a-4752-8012-88068a6b86d0 .pageload", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
