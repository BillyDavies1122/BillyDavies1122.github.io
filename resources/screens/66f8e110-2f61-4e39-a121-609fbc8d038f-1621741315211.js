jQuery("#simulation")
  .on("click", ".s-66f8e110-2f61-4e39-a121-609fbc8d038f .click", function(event, data) {
  ...
  .on("pageload", ".s-66f8e110-2f61-4e39-a121-609fbc8d038f .pageload", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
