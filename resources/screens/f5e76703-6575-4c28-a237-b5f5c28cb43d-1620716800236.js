jQuery("#simulation")
  .on("click", ".s-f5e76703-6575-4c28-a237-b5f5c28cb43d .click", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
    if(jFirer.is("#s-Image_10")) {
      cases = [
        {
          "blocks": [
            {
  ...
  .on("pageload", ".s-f5e76703-6575-4c28-a237-b5f5c28cb43d .pageload", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
