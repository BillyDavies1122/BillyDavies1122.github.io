jQuery("#simulation")
  .on("click", ".s-ae3e4edd-0f5a-4b99-8714-3f2c84cd1733 .click", function(event, data) {
              ...
              "actions": [
                {
                  "action": "jimNavigation",
                  "parameter": {
                    "target": "screens/21147a72-76f5-4cc2-925b-8cbdfd94c7be"
                  },
                  "exectype": "serial",
                  "delay": 0
                }
  ...
  .on("pageload", ".s-ae3e4edd-0f5a-4b99-8714-3f2c84cd1733 .pageload", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
