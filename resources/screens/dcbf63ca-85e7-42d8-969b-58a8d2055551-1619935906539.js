jQuery("#simulation")
  .on("click", ".s-dcbf63ca-85e7-42d8-969b-58a8d2055551 .click", function(event, data) {
  ...
  .on("click", ".s-dcbf63ca-85e7-42d8-969b-58a8d2055551 .toggle", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
  ...
  .on("pageload", ".s-dcbf63ca-85e7-42d8-969b-58a8d2055551 .pageload", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
