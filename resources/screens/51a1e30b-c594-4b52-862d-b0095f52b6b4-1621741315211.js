jQuery("#simulation")
  .on("click", ".s-51a1e30b-c594-4b52-862d-b0095f52b6b4 .click", function(event, data) {
              ...
              "actions": [
                {
                  "action": "jimNavigation",
                  "parameter": {
                    "target": "screens/66f8e110-2f61-4e39-a121-609fbc8d038f",
                    "transition": {
                      "type": "slideleft",
                      "duration": 700
                    }
  ...
  .on("pageload", ".s-51a1e30b-c594-4b52-862d-b0095f52b6b4 .pageload", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
                  ...
                  "parameter": {
                    ...
                    "value": {
                      ...
                      "parameter": {
                        ...
                        "value": {
                          "field": "85d574de-6588-4757-8292-6d168c3558dd"
                        }
                      }
                    }
                  },
  ...
  .on("pageunload", ".s-51a1e30b-c594-4b52-862d-b0095f52b6b4 .pageunload", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
