jQuery("#simulation")
  .on("click", ".s-79675275-6d14-4bb2-8548-dab9a86413a6 .click", function(event, data) {
              ...
              "actions": [
                {
                  ...
                  "parameter": {
                    "target": "screens/51a1e30b-c594-4b52-862d-b0095f52b6b4"
                  },
                  "exectype": "serial",
                  "delay": 0
                }
  ...
  .on("pageload", ".s-79675275-6d14-4bb2-8548-dab9a86413a6 .pageload", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
