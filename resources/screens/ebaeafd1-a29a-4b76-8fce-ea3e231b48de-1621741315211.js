jQuery("#simulation")
  .on("click", ".s-ebaeafd1-a29a-4b76-8fce-ea3e231b48de .click", function(event, data) {
              ...
              "actions": [
                {
                  ...
                  "parameter": {
                    ...
                    "fields": {
                      ...
                      "9ec45deb-211f-4330-b504-c65a9dc220ef": {
                        "datatype": "property",
                        "target": "#s-Input_5",
                        "property": "jimGetValue"
                      }
  ...
  .on("pageload", ".s-ebaeafd1-a29a-4b76-8fce-ea3e231b48de .pageload", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
  ...
  .on("pageunload", ".s-ebaeafd1-a29a-4b76-8fce-ea3e231b48de .pageunload", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
