jQuery("#simulation")
  .on("click", ".s-46884e45-e1b3-4fa8-9f1f-6c58a763e060 .click", function(event, data) {
  ...
  .on("pageload", ".s-46884e45-e1b3-4fa8-9f1f-6c58a763e060 .pageload", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
