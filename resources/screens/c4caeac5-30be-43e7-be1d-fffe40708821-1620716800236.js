jQuery("#simulation")
  .on("click", ".s-c4caeac5-30be-43e7-be1d-fffe40708821 .click", function(event, data) {
              ...
              "actions": [
                {
                  "action": "jimNavigation",
                  "parameter": {
                    "target": "screens/314e8bfc-2d4a-4752-8012-88068a6b86d0"
                  },
                  "exectype": "serial",
                  "delay": 0
                }
  ...
  .on("pageload", ".s-c4caeac5-30be-43e7-be1d-fffe40708821 .pageload", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
